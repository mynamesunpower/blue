<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%int startdate = (int)request.getAttribute("startdate"); %>
   <%int enddate = (int)request.getAttribute("enddate"); %>
            ...
            <div class="row small-gutters categories_grid">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="row small-gutters mt-md-0 mt-sm-2">
                     <c:forEach items="${list}" var="list"  varStatus="status" begin="1" end="4">  
                        <div class="col-sm-3">
