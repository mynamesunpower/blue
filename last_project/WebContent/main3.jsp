...
<script>
      ...
      $.get("mongoDB/festival.json", function(data) {
       ...
       var markers = $(data).map(function(i, data) {
		 ...
		 console.log(data.image)
           ...
           '        <div class="title">' + 
           data.festival_name+'            ' + 
           '            <div class="close" onclick="dddd()" title="닫기"></div>' + 
           '        </div>' + 
           '        <div class="body">' + 
           //'            <div class="img">' +
           //'                <img src="data:image/jpg;base64,'+data.image[0].data+'" width="73" height="70">' +
           //'           </div>' + 
           '            <div class="desc">' + 
           '                <div class="ellipsis">'+data.address+'</div>' + 
           '                <div class="jibun ellipsis">'+data.address_detail+'</div>' + 
           '                <div class="jibun ellipsis">'+data.tel+'</div>' + 
          // '                <div>'+data.tel+'</div>' + 
           '                <div><a href="/details.do?postcode="'+data.postcode+' target="_blank" class="link">자세히보기</a></div>' + 
           '            </div>' + 
           '        </div>' + 
           '    </div>' +    
           '</div>';
		   ...
		   kakao.maps.event.addListener(maks, 'mouseout', function() {
			   openthedoor()
   		});
    ...
    function dddd() {
    	openthedoor().overlay.setMap(null);     
	}
